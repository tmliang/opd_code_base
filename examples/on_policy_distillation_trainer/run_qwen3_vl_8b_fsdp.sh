...
teacher_model=Qwen/Qwen3-VL-32B-Instruct
train_file=$HOME/data/geo3k/train.parquet
val_file=$HOME/data/geo3k/test.parquet
...
# ---- trainer ----
project_name=verl_distill_geo3k
experiment_name=qwen3_vl_8b_from_qwen3_vl_32b_vllm_fsdp
total_epochs=15
save_freq=200
test_freq=5
